  ...
  ingredients: [
    {
      ...
      spoons: { quantity: 200, unit: 'g' },
    },
    {
      name: 'butter',
      quantity: 3,
      unit: 'tbsp',
      metric: { quantity: 42, unit: 'g' },
      spoons: { quantity: 3, unit: 'tbsp' },
    },
    {
      name: 'garlic cloves',
      quantity: 4,
      unit: 'cloves',
      metric: { quantity: 4, unit: 'clove' },
      spoons: { quantity: 4, unit: 'clove' },
    },
    {
      name: 'parmesan',
      quantity: 0.25,
      unit: 'cup',
      metric: { quantity: 25, unit: 'g' },
      spoons: { quantity: 0.25, unit: 'cup' },
    },
    {
      name: 'olive oil',
      quantity: 1,
      ...
      spoons: { quantity: 1, unit: 'tbsp' },
    },
    {
      name: 'parsley',
      quantity: 2,
      unit: 'tbsp',
      metric: { quantity: 8, unit: 'g' },
      spoons: { quantity: 2, unit: 'tbsp' },
    },
  ],
  instructions: [
