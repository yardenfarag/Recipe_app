export default {
  ...
  "settings": {
    ...
    "planBlurb": "Pinch Plus will be {{price}} when billing goes live. Saved recipes, remixes, and translations never burn your extract quota. {{billingNote}}",
    ...
    "deleteConfirmBody": "This permanently deletes your recipes, photo, plan, and account. There’s no undo.",
  ...
  "recipe": {
    ...
    "guestLimitBody": "Guests can save up to {{limit}} recipes ({{saved}} saved). Sign up to save more.",
